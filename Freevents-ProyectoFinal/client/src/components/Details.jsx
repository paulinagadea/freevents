...
const Details = () => {
    ...
    console.log("🚀 ~ file: Details.jsx ~ line 15 ~ Details ~ myservice", myservice)
    ...
    console.log("🚀 ~ file: Details.jsx ~ line 20 ~ Details ~ nombrepack", nombrepack)
    console.log("🚀 ~ file: Details.jsx ~ line 19 ~ Details ~ packs", packs)
    const auxProvId = myservice.id
    console.log("🚀 ~ file: Details.jsx ~ line 21 ~ Details ~ auxProvId", auxProvId)
    const auxPackId = packs.map((idPack) => idPack.providerId)
    console.log("🚀 ~ file: Details.jsx ~ line 25 ~ Details ~ auxPackId", auxPackId)
    const verificacion = auxPackId.includes(auxProvId)
    const coincidencia = packs.filter((e)=>e.providerId===auxProvId)
    console.log("🚀 ~ file: Details.jsx ~ line 27 ~ Details ~ coincidencia", coincidencia)
