...
import { LogoutButton } from './ButtonLogoutPacksRoute'
...
export default function NavbarHome() {
  ...
  const userStorage = JSON.parse(localStorage.getItem("providerUser"))
  console.log('esto es userStorage:', userStorage)
  const handleClose = () => {
    setAnchorEl(null);
  };
